...
io.on('connection', (socket) => {
  ...
  socket.on('SEND_MESSAGE', (data) => {
    ...
    if(text === 'hello' || text === 'hi') {
      response_message = "Hi, nice to meet you!";
    }
    else if(text.indexOf('活大') > -1) {
      response_message = "活大！！！！ 難吃！！！";
    }
    else {
      response_message = "none";
    }

    var data_bot = {from:'bot', message: response_message };
    log.push(data);
    io.emit('RECEIVE_MESSAGE', data_bot);
  });
});
